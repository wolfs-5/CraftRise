...
import { Home, Palette, Calendar, MessageCircle, Settings, ChevronLeft, ChevronRight, Sparkles, Heart, Wand2 } from "lucide-react";

const navigation = [
  { name: "Dashboard", href: "/dashboard", icon: Home, description: "Your craft journey home" },
  { name: "PhotoEnhance Studio", href: "/marketplace/photo-listing", icon: Wand2, description: "AI-powered photo enhancement", badge: "Popular" },
  { name: "StoryWeaver", href: "/storyweaver", icon: Palette, description: "Transform photos into stories", badge: "New" },
  { name: "SocialCraft", href: "/marketplace/social-craft", icon: Calendar, description: "AI social media calendar", badge: "New" },
...
export function DashboardSidebar() {
  ...
  return (
    <div
      className={cn(
        "flex flex-col h-screen bg-sidebar border-r border-sidebar-border transition-all duration-300 ease-in-out cultural-pattern sticky top-0 overflow-y-auto",
        collapsed ? "w-16" : "w-64"
      )}
    >
