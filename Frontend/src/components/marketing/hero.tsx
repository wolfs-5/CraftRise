    ...
    <section id="home" className="relative overflow-hidden min-h-screen flex items-center">
      ...
      <div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl">
          <h1 className="font-serif text-5xl sm:text-6xl lg:text-7xl font-bold text-white leading-tight text-balance mb-8 drop-shadow-2xl">
            Bridging Heritage<br />with Modernity
          </h1>

          <p className="text-xl sm:text-2xl text-white/95 font-light text-pretty mb-8 max-w-3xl leading-relaxed drop-shadow-lg">
            Empowering India&apos;s master craftspeople to reach global markets while preserving our rich cultural heritage.
          </p>

          <p className="text-lg text-white/90 leading-relaxed text-pretty mb-12 max-w-2xl drop-shadow-md">
