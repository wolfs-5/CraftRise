...
import { MessageSquare, Hash, Calendar, Headphones } from "lucide-react";
...
const features = [
  ...
  },
  {
    ...
    title: "SocialCraft",
    description:
      "AI-powered social media calendar with personalized content, captions, hashtags, and optimal posting times for your craft story.",
  },
  {
    icon: Headphones,
